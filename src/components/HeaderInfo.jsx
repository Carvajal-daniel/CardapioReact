...
export const HeaderInfo = () => {
  return (
    <div className="flex  justify-between -mt-8 xl:px-9 xl:py-1 xl:w-[980px] bg-[#f5f5f5] rounded-t-[40px] px-5 py-2 border-b border-zinc-300 md:w-[1150px] md:mx-auto flex-col ">
