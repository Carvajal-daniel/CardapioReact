      ...
      >
        {menu.map((item, index) => (
          <SwiperSlide key={index}>
            ...
            <button
              className={`flex mx-auto font-secondary cursor-pointer items-center justify-center rounded-t gap-2 px-2 text-lg text-text-primary py-2 my-2 w-full xl:py-2 xl:text-md
